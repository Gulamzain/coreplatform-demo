...
export const metadata = {
  title: 'Techwind - Next Js Multipurpose App, Saas & Software Landing & Admin Dashboard Template',
  description: 'Techwind - Next Js Multipurpose App, Saas & Software Landing & Admin Dashboard Template',
}
